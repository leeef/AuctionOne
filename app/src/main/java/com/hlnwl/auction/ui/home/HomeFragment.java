...
import com.hlnwl.auction.view.dialog.UpdateDialog;
            ...
            case R.id.home_selet_language:
                ...
                morePopup.setOnMoreItemListener(new MorePopup.OnItemClickListener() {
                    ...
                    public void OnItemClick(int position,String content) {
                        switch (position){
                            case 0:
                                LanguagesManager.setAppLanguage(getActivity(), Locale.CHINA);
                                SPUtils.setLanguage("1");
                                break;
                            case 1:
                                LanguagesManager.setAppLanguage(getActivity(), Locale.ENGLISH);
