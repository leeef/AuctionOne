 ...
 * 描述：
 */
public class SpecialExhibitionBannerItemProvider extends
        BaseItemProvider<SpecialExhibitionMultipleItem, BaseViewHolder> {
    private List<String> bannerImgs = new ArrayList<>();
    @Override
    public int viewType() {
        return SpecialExhibitionListAdapter.BANNER;
    }
