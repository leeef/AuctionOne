 ...
 * @author yougui
 * 版本：1.0
 * 创建日期：2019/9/28 16:48
 * 描述：
 */
public class BidRecordActivity extends MyActivity {
    ...
    private static final String[] CHANNELS = new String[]{StringUtils.getString(R.string.bidding),
            StringUtils.getString(R.string.bid_success)};
    ...
    private void initFragment() {
        fragmentList.add(new BidFragment("1"));
        fragmentList.add(new BidFragment("2"));
